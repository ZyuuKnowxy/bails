...
const { getContentType, normalizeMessageContent } = require('../Utils/messages.js');
const { areJidsSameUser, isHostedLidUser, isHostedPnUser, isJidBroadcast, isJidStatusBroadcast, isLidUser, jidDecode, jidEncode, jidNormalizedUser } = require('../WABinary/index.js');
const { aesDecryptGCM, hmacSign } = require('./crypto.js');
const { getKeyAuthor, toNumber } = require('./generics.js');
const { downloadAndProcessHistorySyncNotification } = require('./history.js');
const { buildMergedTcTokenIndexWrite, resolveTcTokenJid } = require('./tc-token-utils.js');
...
module.exports.default = processMessage;
